...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'luxo':
				tex = Paths.getSparrowAtlas('luxo_assets','shared');
				frames = tex;
				animation.addByPrefix('idle', "luxo idle", 24);
				animation.addByPrefix('singUP', 'luxo up note', 24, false);
				animation.addByPrefix('singDOWN', 'luxo down note', 24, false);
				animation.addByPrefix('singLEFT', 'luxo left note', 24, false);
				animation.addByPrefix('singRIGHT', 'luxo right note', 24, false);
